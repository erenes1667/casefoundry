...
| PETG Translucent | 0.12 mm | 260 °C | 70 °C | 1 | 18 mm/s | 15 mm/s | 0–20%, bridges 50% |
...
- use 1.35 mm back thickness and 0.40 mm artwork depth
...
Prefer 3MF for sealed art. It contains named `Case shell` and `Buried artwork inlay` objects. Import as one assembly if prompted, assign materials per object, keep the objects aligned at their original coordinates, and slice back-flat.
